...
before running [execute-plan](../skills/execute-plan.md).

## Inputs Accepted

- **Slug** — resolves to `$ARTIFACT_DIR/<scope>/<slug>/<slug>-plan.md` (resolve `<scope>` per [artifact-dir](../references/artifact-dir.md))
