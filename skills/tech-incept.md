...
Immediately after the design document title, add:
...
When updating an existing design with a different model, preserve the original
line and add `*Updated by: <exact runtime model identifier>*` below it.
